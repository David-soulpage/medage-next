...
// layout
import { MarketingLayoutLight } from "layouts";

const SignInPage = () => {
  const [globalState, globalDispatch] = useContext(globalContext);

  const title = "Sign-In | Level";
    ...
    LogIn(payload)
      ...
      .catch((error) => {
        ...
        globalDispatch({
          ...
          payload: { kind: "warning", description: "Please check your Credentials." },
        });
      });
  };
            ...
            <div className="col-md-6 align-self-center">
              <div className="card border-0 shadow px-4 py-4">
                  ...
                  <Form onSubmit={formSubmit}>
                    <Form.Group controlId="signin-email">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => handleFormDetails("email", e.target.value)}
                      />
                    </Form.Group>
                    ...
                    <Form.Group controlId="singin-password">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) => handleFormDetails("password", e.target.value)}
                      />
                    </Form.Group>
                ...
                <div className="card-footer bg-white text-muted mt-2">
                  <small>
                    We'll never share your email with anyone else. By continuing you accept the
